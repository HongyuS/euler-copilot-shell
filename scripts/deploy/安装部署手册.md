...
~~~bash
#创建mcp服务
openEuler-Intelligence-Install --a init config.json
...
#创建一一对应的agent应用
openEuler-Intelligence-Install --a create config.json
...
#创建多对一的agent应用
openEuler-Intelligence-Install --a comb config.json
...
~~~
[root@localhost deploy]# openEuler-Intelligence-Install --a init /root/mcp_config/perf_mcp/config.json 
...
[root@localhost deploy]# openEuler-Intelligence-Install --a create /root/mcp_config/perf_mcp/config.json 
